...
\hypersetup{pdfauthor={Jérôme Ortais},pdfsubject={Exercicis de
    matemátiques},pdftitle={Exercicis creats per Pyromaths, un programari liure
...
\renewcommand{\headrulewidth}{0pt}% filet en la part superior de la pàgina
\lhead{} \chead{} \rhead{}

\begin{document}
\currentpdfbookmark{Los enunciados}{Énoncés}
\newcounter{nocalcul}[exo]
\renewcommand{\thenocalcul}{\Alph{nocalcul}}
\raggedcolumns
\setlength{\columnseprule}{0.5pt}
{\noindent \textbf{NOMBRE :} \hfill \textbf{(( nivel ))}}\par
...
\newpage
\currentpdfbookmark{Correcció de l'exercici}{Corrigé}
