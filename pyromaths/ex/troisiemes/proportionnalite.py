...
def proportionnalite_3eme():
    ...
    ligne2 = [_(u"\\item Bus A : %s élèves dont %s %s de garçons.") % (totB, prctB, "\\%"),
    ...
    correction = [  # Dans le bus
        ...
        # À l'ordinateurs
        [_(u"En quatrièmes, $\\cfrac{%s \\times %s}{100} = %s$ élèves possèdent un ordinateur.\\par") % (
        prctA, totA, decimaux(nbA)),
         _(u"En troisièmes, $\\cfrac{%s \\times %s}{100} = %s$ élèves possèdent un ordinateur.\\par") % (
